...
#Import data
data <- import("data/Wave1.rda") 

# BC: I had to specify the specific directory for it to work for me. maybe try using {here}?
...
# BC: nice. for a simpler solution or just for future reference, you might want to look at dplyr::mutate_at.
...
# BC: I think if you use janitor::clean_names it will fix the levels of the factors for you so you don't have to deal with strings with spaces in them
...
# BC: great! could also use group_by(Grade) %>% nest()
...
# BC: Could you turn this 'defining plots' part into a function? Consider if you had 100 plots instead of just 5
