...
#Load libraries
#install.packages("pacman") ##--- may not be necessary as you already use 'p_load' below
#--- to load and install the library - Teresa
...
} ##--- nice use of regular expressions! - Teresa
...
screen_3 <- screen_2 %>% 
            mutate(identity = select(., White:Other) %>% 
                   rowSums(na.rm = TRUE))   ##--- really smart and neat code! -Teresa
